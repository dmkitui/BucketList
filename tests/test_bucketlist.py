...
class BucketListEndpoints(base_test.BaseBucketListCase):
    ...
    def test_bucketlist_create_bucektlist(self):
    ...
    def test_get_no_bucketlist_available(self):
    ...
    #
    #     response4 = self.client().put('/api/v1/bucketlists/{}'.format(buckelist_id),
    #                                   headers=dict(Authorization="Bearer " + token),
    #                                   data=dict(list_item_name='Intro to Java'))
    #     self.assertEqual(response4.status_code, 201)
    #
    #     response5 = self.client().put('/api/v1/bucketlists/{}'.format(buckelist_id),
    #                                   headers=dict(Authorization="Bearer " + token),
    #                                   data=dict(list_item_name='Intro to Python'))
    ...
    def test_edit_bucketlist_name_not_given(self):
        ...
        self.assertIn('Update name not given.', str(response2.data))
    ...
    #     token = response['access_token']
    #
    #     self.client().post('/api/v1/bucketlists/', headers=dict(Authorization="Bearer " + token),
    #                        data=dict(name='Learn Programming'))
    #     self.client().put('/api/v1/bucketlists/1', headers=dict(Authorization="Bearer " + token),
    #                       data=dict(list_item_name='Python django'))
    #
    #     # post the same item list again
    #     response2 = self.client().put('/api/v1/bucketlists/1', headers=dict(Authorization="Bearer " + token),
    #                                   data=dict(list_item_name='Python django'))
    #
    ...
    def test_bucketlist_delete_list_item(self):
        ...
        response2 = self.client().post('/api/v1/bucketlists/', headers=dict(Authorization="Bearer " + token),
                                       data=dict(name='Learn Programming'))
        self.assertEqual(response2.status_code, 201)
